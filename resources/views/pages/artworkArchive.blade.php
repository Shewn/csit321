                        ...
                        <table class="table table-hover" id="myTable">
                            ...
                            <tr>
                                ...
                                <td style="width:32%;">
                                    ...
                                    <button id="red" class="text-white btn-sm" data-toggle="modal" data-target="#removeModal-{{$art->Accession_number}}">Recover</button>
                                    <button id="red" class="text-white btn-sm" data-toggle="modal" data-target="#deleteModal-{{$art->Accession_number}}">Delete</button>
            ...
            <div class="modal-body mt-4 mb-4">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {{Form::hidden('archive','', ['class' => 'form-control mb-4', 'placeholder' => $art->Archieve])}} 
                        
                    </div>
                    <h4><i class="far fa-question-circle ml-3"></i>&nbsp;&nbsp;Are you sure to recover this artwork?</h4>
                    <h5 style="text-align: center;">&nbsp;&nbsp;Accession Number: {{$art->Accession_number}}</h4>
                <div class="form-group">
                    
                    {{Form::hidden('tracker_id',1, ['class' => 'form-control mb-4', 'placeholder' => $art->Tracker_ID])}} 
...
@foreach($arts as $art)
<!-- Delete Modal -->
<div class="modal fade" id="deleteModal-{{$art->Accession_number}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true" >
    <!-- Change class .modal-sm to change the size of the modal -->
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mt-4 mb-4">
                {!! Form::open(['action' => ['PagesController@destroy',$art->Accession_number], 'method' => 'POST']) !!}
               
                   
                    
                    
                   
                    <h4><i class="far fa-question-circle ml-3"></i>&nbsp;&nbsp;Are you sure to delete this artwork?</h4>
                    <h5 style="text-align: center;">&nbsp;&nbsp;Accession Number: {{$art->Accession_number}}</h4>
               
                
                {{ Form::hidden('_method','DELETE')}} 
                <div class="modal-footer">
                        <button id="red" type="submit" class="btn btn-danger" style="width:163px;">Yes</button>
                        <button id="blue" type="button" class="btn text-white" data-dismiss="modal" style="width:163px;margin-right:12.5%">No</button>
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::hidden('archive',$art->Archieve ,['class' => 'form-control mb-4', 'placeholder' => $art->Archieve])}} 
