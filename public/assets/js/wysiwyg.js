...
(function ($) {
  ...
  function () {
    ...
    _createClass(WYSIWYG, [{
      ...
      value: function performAction(e) {
        ...
        document.execCommand($btn.data('action'), false, null);
      }
    }, {
      key: "changeTagName",
  ...
  $.fn.mdbWYSIWYG = function (options) {
    ...
    return this.each(function () {
      var wysiwyg = new WYSIWYG($(_this2), options);
      wysiwyg.init();
    });
  };
})(jQuery);
